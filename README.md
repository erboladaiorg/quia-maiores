...
var helpMe = require('@erboladaiorg/quia-maiores')
...
```js
import { help } from '@erboladaiorg/quia-maiores'
...
var path = require('path')
var help = require('@erboladaiorg/quia-maiores')({
  dir: path.join(__dirname, 'doc')
})
